...
if __name__ == "__main__":
	...
	Label(avtrRoot, text="Chọn avatar của bạn", font=('arial bold', 15), bg=background, fg='#303E54').pack(pady=10)
	...
	Button(BottomFrame, text='         Cập nhật         ', font=('Montserrat Bold', 15), bg='#01933B', fg='white', bd=0, relief=FLAT, command=SavePhoto).grid(row=0, column=0, padx=10)
	Button(BottomFrame, text='         Thoát         ', font=('Montserrat Bold', 15), bg='#EDEDED', fg='#3A3834', bd=0, relief=FLAT, command=closeWindow).grid(row=0, column=1, padx=10)
